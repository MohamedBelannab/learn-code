        ...
        <div className="illustration-editor">
            ...
            <div className="code code-html">
              ...
              <div className="code-content">
                <code>
                  ...
                  <span className="c-g">"laravel"</span>
                  <span className="c-r">&gt;&lt;/div&gt;</span>
                </code>
              </div>
              <code></code>
          ...
          <div className="code code-css">
            ...
            <div className="code-content">
              <code >
                <p className="line-1">
                  <span className="c-y"> &lt;?php</span> 
                </p>
                <br />
                <p className="line-2">
                  <span className="c-p">echo</span>
                  <span>:</span> <span className="c-y">"My first PHP script!" ;</span>
                </p>
                <br />
                <p className="line-4">
                  <span className="c-y">$n =</span> <span className="c-o">9</span>,
                </p>
                <br />
                <p className="line-5">
                  <span className="c-y">echo</span>
                  <span className="c-o">  $n </span> <span className="c-y"> {'?>'}</span> 
                </p>
              </code>
            </div>
          </div>
